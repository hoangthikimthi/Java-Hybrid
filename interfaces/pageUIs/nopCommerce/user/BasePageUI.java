...
public class BasePageUI {
	...
	public static final String REWARD_LINK = "//div[contains(@class,'account-navigation')]//a[text()='Reward points']";
	...
	public static final String LOGOUT_LINK_AS_USER = "//a[@class='ico-logout']";
	public static final String LOGOUT_LINK_AS_ADMIN = "//a[text()='Logout']";
