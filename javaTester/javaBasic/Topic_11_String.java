...
public class Topic_11_String {
	...
	public Topic_11_String(int id, String name, int age, int score) {
		this.id = id;
		this.name = name;
		this.age = age;
		this.score = score;
	...
	public static void main(String[] args) {
		Topic_11_String[] students = new Topic_11_String[3];
		students[0] = new Topic_11_String(1, "a", 4, 10);
		students[1] = new Topic_11_String(2, "b", 5, 9);
		students[2] = new Topic_11_String(3, "c", 6, 8);
		for (int i = 0; i < 3; i++) {
			students[i].display();
		}
	}
